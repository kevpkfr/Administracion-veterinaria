...
const Step3_Horarios = ({ nextStep, prevStep, updateFormData, formData }) => {
  ...
  return (
    <div className="space-y-6">
      <h3 className="text-2xl font-bold text-[#E76F24] mb-6">Paso 3: Horarios de Atención</h3>

      <div>
        <label className="block text-sm font-semibold text-[#FF8C42] mb-2">Horario de Apertura:</label>
        <input 
          type="time" 
      ...
      <div>
        <label className="block text-sm font-semibold text-[#FF8C42] mb-2">Horario de Cierre:</label>
        <input 
          type="time" 
          className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#E76F24]"
      ...
      <div>
        <label className="block text-sm font-semibold text-[#FF8C42] mb-2">Días de Atención:</label>
